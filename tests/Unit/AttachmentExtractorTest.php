...
{
    public function test_collects_and_deduplicates_direct_pdf_attachments(): void
    {
    ...
    public function test_collects_pdf_from_acf_file_field_and_skips_non_pdf(): void
    {
        Functions\when('get_attached_media')->justReturn([]);
